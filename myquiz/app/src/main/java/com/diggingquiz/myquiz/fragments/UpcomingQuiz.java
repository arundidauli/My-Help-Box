...
public class UpcomingQuiz extends BaseFragment implements ApiCallbackListener {
    ...
    public void getDateRange() {
        ...
        //FilterData(simpleDateFormat.format(cal1.getTime()), simpleDateFormat.format(d2));
    ...
    private void setQuizeList() {

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd/MMM/yyyy");
        for (Date date : satSunArraylist) {
            count++;
 ...
 /*       Collections.sort(quizeFilterArrayList, new Comparator<QuizeListData>(){
      ...
      /*  adapter = new CurrentExamQuizeAdapter(getActivity(), quizeFilterArrayList,1);
    ...
    public void onResultCallback(String response, String flag) {
        ...
        try {
            if(flag!=null && flag.equalsIgnoreCase("getupcoming")){
                ...
                JSONArray jsoncurrentquiz = new JSONArray(objMain.getString("UpcommingQuizList"));
