...
public class WithdrawlistData implements Parcelable {
    ...
    public WithdrawlistData(Parcel in) {
    ...
    public static final Creator<WithdrawlistData> CREATOR = new Creator<WithdrawlistData>() {
        public WithdrawlistData createFromParcel(Parcel in) {
            return new WithdrawlistData(in);
        }

        public WithdrawlistData[] newArray(int size) {
            return new WithdrawlistData[size];
        }
    };
