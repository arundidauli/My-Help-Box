package com.techastrum.sattaresult;
...
*/
        ...
        recyclerView = findViewById(R.id.productListData);
    ...
    private void data() {
        ...
        productListData.add(new ProductListData("Desawar", "67"));  productListData.add(new ProductListData("Dheli", "34"));
        productListData.add(new ProductListData("Desawar", "67"));  productListData.add(new ProductListData("Dheli", "34"));
        productListData.add(new ProductListData("Desawar", "67"));  productListData.add(new ProductListData("Dheli", "34"));
        productListData.add(new ProductListData("Desawar", "67"));  productListData.add(new ProductListData("Dheli", "34"));
        productListData.add(new ProductListData("Desawar", "67"));  productListData.add(new ProductListData("Dheli", "34"));
        productListData.add(new ProductListData("Desawar", "67"));
    }
}